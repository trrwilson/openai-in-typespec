...
{
    private readonly Internal.CreateSpeechRequestVoice _internalVoice;
    ...
    public TextToSpeechVoice(string value)
        : this(new Internal.CreateSpeechRequestVoice(value))
    { }

    internal TextToSpeechVoice(Internal.CreateSpeechRequestVoice internalVoice)
    {
    ...
    /// The <c>onyx</c> voice.
    /// </summary>
    public static TextToSpeechVoice Onyx { get; } = new TextToSpeechVoice(Internal.CreateSpeechRequestVoice.Onyx);
    /// <summary>
    /// The <c>shimmer</c> voice.
    /// </summary>
    public static TextToSpeechVoice Shimmer { get; } = new TextToSpeechVoice(Internal.CreateSpeechRequestVoice.Shimmer);
    /// <summary>
    /// The <c>alloy</c> voice.
    /// </summary>
    public static TextToSpeechVoice Alloy { get; } = new TextToSpeechVoice(Internal.CreateSpeechRequestVoice.Alloy);
    /// <summary>
    /// The <c>fable</c> voice.
    /// </summary>
    public static TextToSpeechVoice Fable { get; } = new TextToSpeechVoice(Internal.CreateSpeechRequestVoice.Fable);
    /// <summary>
    /// The <c>echo</c> voice.
    /// </summary>
    public static TextToSpeechVoice Echo { get; } = new TextToSpeechVoice(Internal.CreateSpeechRequestVoice.Echo);
    ...
    public static implicit operator TextToSpeechVoice(string value)
        => new TextToSpeechVoice(new Internal.CreateSpeechRequestVoice(value));
    /// <inheritdoc/>
    public static bool operator !=(TextToSpeechVoice left, TextToSpeechVoice right)
        => left._internalVoice != right._internalVoice;
    /// <inheritdoc/>
