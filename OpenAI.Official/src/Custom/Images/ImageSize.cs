...
{
    private readonly Internal.Models.CreateImageRequestSize _internalSize;
    ...
    public ImageSize(string value)
        : this(new Internal.Models.CreateImageRequestSize(value))
    { }

    internal ImageSize(Internal.Models.CreateImageRequestSize internalSize)
    {
    ...
    /// </para>
    /// </summary>
    public static ImageSize Size1024x1024 { get; } = new ImageSize(Internal.Models.CreateImageRequestSize._1024x1024);
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public static ImageSize Size1024x1792 { get; } = new ImageSize(Internal.Models.CreateImageRequestSize._1024x1792);
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public static ImageSize Size1792x1024 { get; } = new ImageSize(Internal.Models.CreateImageRequestSize._1792x1024);
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public static ImageSize Size256x256 { get; } = new ImageSize(Internal.Models.CreateImageRequestSize._256x256);
    /// <summary>
    ...
    /// </para>
    /// </summary>
    public static ImageSize Size512x512 { get; } = new ImageSize(Internal.Models.CreateImageRequestSize._512x512);
    /// <inheritdoc/>
