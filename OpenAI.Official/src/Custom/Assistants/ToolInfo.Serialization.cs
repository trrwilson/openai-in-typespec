...
public abstract partial class ToolInfo : IUtf8JsonWriteable, IJsonModel<ToolInfo>
{
    ...
    void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ToolInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
